...
namespace ESOL_EDU.Controllers
{
    public class AccountController : Controller
    {
        ...
        [HttpPost]
        public ActionResult Login(LoginDomain model, string returnUrl)
        {
            ...
            {
                UserDomain userInfo = DataAccess.UserInfoDao.Login(model);
        ...
        public void StoreSession(UserDomain domain)
        {
            Session["UserInfo"] = domain;
        }
